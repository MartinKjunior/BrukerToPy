...
| Q.MS1.002.[j] <button class="md-button md-button--hyperlink">HYPERLINK</button> | <a id="S_BL"></a> Baseline signal | -- | *S<sub>BL,j</sub>* | Pre-contrast MR signal (magnitude, phase or complex depending on context) in compartment *j* before the arrival of indicator at the tissue of interest. | a.u. | -- |
...
| Code | OSIPI name | Alternative names|Notation|Description|OSIPI units|Reference|
| -- | -- | -- | -- | -- | -- | -- |
| Q.EL1.001.[j] <button class="md-button md-button--hyperlink">HYPERLINK</button> | <a id="R1"></a> Longitudinal relaxation rate | *R<sub>1</sub>* -relaxation rate | $R_{1,j}$ | Longitudinal relaxation rate in compartment *j*. | 1/s | -- |
| Q.EL1.002.[j] <button class="md-button md-button--hyperlink">HYPERLINK</button> | <a id="R10"></a> Native longitudinal relaxation rate |Baseline *R<sub>1</sub>* | $R_{10,j}$ | Longitudinal relaxation rate in compartment *j*. | 1/s | -- |
| Q.EL1.003.[j] <button class="md-button md-button--hyperlink">HYPERLINK</button> | <a id="DeltaR1"></a> Change in longitudinal relaxation rate  | -- | $\Delta R_{1,j}^*$ | Change in longitudinal relaxation rate with respect to $R_{10,j}$ in compartment *j*. | 1/s | -- |
...
| Code | OSIPI name| Alternative names|Notation|Description|OSIPI units|Reference|
| -- | -- | -- | -- | -- | -- | -- |
| Q.IC1.001.[j] <button class="md-button md-button--hyperlink">HYPERLINK</button> | <a id="C"></a> Indicator concentration | -- | *C<sub>j</sub>* | Concentration of indicator molecules in compartment *j*. | mM | -- |
